...
namespace QuanLiNhanSuVaTienLuong.DAL
{
    public class DataAccess
    {
        ...
        public static SqlConnection getConnect()
        {
            ...
            //Helper h = new Helper();
            //SqlConnection cn = h.getConnect();
            SqlConnection cn = new SqlConnection(strcon);
            cn.Open();
            return cn;
        }
        public static SqlConnection getConnectPublic()
        {
            string strcon = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
            //Helper h = new Helper();
            //SqlConnection cn = h.getConnect();
        ...
        public DataTable GetDataTable_Store_Paramater(string TenStoreProdure, SqlParameter[] sqlParam)
        {
            ...
            try
            {
                ...
                sqlCmd.CommandText = TenStoreProdure;
        ...
        internal object Load_theo_ma(string v, int code)
        {
